...
ENDIF()
MESSAGE(STATUS "CPACK: PackageFileName ${CPACK_PACKAGE_FILE_NAME}")
...
#   ENDIF()
	...
	SET(CPACK_DEBIAN_PACKAGE_NAME "morpheus")
	SET(CPACK_DEBIAN_FILE_NAME "${CPACK_DEBIAN_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION}")
	# Append the tag at packaging time
	IF (DEFINED CPACK_PACKAGE_NAME_TAG)
		STRING(APPEND CPACK_DEBIAN_FILE_NAME "~${CPACK_PACKAGE_NAME_TAG}")
	ENDIF()
	STRING(APPEND CPACK_DEBIAN_FILE_NAME ".deb")
