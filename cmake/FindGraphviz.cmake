...
if(GRAPHVIZ_FOUND)
  ...
  elseif(WIN32)
    find_program(DOT_TOOL dot PATHS ${_GRAPHVIZ_ROOT}/bin NO_DEFAULT_PATH NO_CMAKE_PATH NO_CMAKE_ENVIRONMENT_PATH NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH)
    set(DOT_TOOL "C:/Program\ Files/GraphViz/bin/dot.exe")
    execute_process(COMMAND ${DOT_TOOL} -V OUTPUT_VARIABLE DOT_VERSION_OUTPUT ERROR_VARIABLE DOT_VERSION_OUTPUT OUTPUT_QUIET)
    set(DOT_VERSION_OUTPUT "dot - graphviz version 2.38.0 (20140413.2041)")
    message(STATUS "Found Graphviz version ${DOT_VERSION_OUTPUT} from ${DOT_TOOL} ${_GRAPHVIZ_ROOT}"   )
