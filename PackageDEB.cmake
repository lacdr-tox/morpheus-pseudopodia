...
IF(DEFINED MORPHEUS_BETA)
	#	set(CPACK_PACKAGE_VERSION_PATCH "${CPACK_PACKAGE_VERSION_PATCH}~beta${MORPHEUS_BETA}")
	set(CPACK_PACKAGE_NAME_TAG "beta${MORPHEUS_BETA}")
ENDIF()
#SET(CPACK_DEBIAN_FILE_NAME ${CPACK_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION_MAJOR}.${CPACK_PACKAGE_VERSION_MINOR}.${CPACK_PACKAGE_VERSION_PATCH}.deb)
